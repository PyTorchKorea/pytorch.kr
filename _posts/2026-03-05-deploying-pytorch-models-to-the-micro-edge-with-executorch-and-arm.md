...
PyTorch는 모델 실험을 빠르고 직관적으로 할 수 있게 해주지만, 동적 그래프의 유연성에서 임베디드 하드웨어의 엄격한 제약 조건으로 전환하는 것은 쉽지 않습니다. 대부분의 마이크로컨트롤러는 RAM이 1MB 미만이고 운영체제가 없기 때문에, 기존의 Python 추론은 사용할 수 없습니다.
