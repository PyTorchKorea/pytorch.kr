...
function commandMessage(key) {
  var object = {
    ...
    "preview,pip,linux,rocm4.x,python": "pip3 install --pre torch torchvision --extra-index-url https://download.pytorch.org/whl/nightly/rocm4.3.1",
    ...
    "preview,conda,linux,rocm4.x,python": "<b>NOTE:</b> Conda packages are not currently available for ROCm, please use pip instead<br />",
    ...
    "preview,libtorch,linux,rocm4.x,cplusplus": "LibTorch binaries are not available for ROCm, please build it from source",
    "preview,pip,macos,cuda10.2,python": "# On MacOS, we provide CPU-only packages, CUDA functionality is not provided<br />pip3 install --pre torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/nightly/cpu",
    "preview,pip,macos,cuda11.x,python": "# On MacOS, we provide CPU-only packages, CUDA functionality is not provided<br />pip3 install --pre torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/nightly/cpu",
    "preview,pip,macos,rocm4.x,python": "# ROCm is not available on MacOS<br />pip3 install --pre torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/nightly/cpu",
    "preview,pip,macos,accnone,python": "pip3 install --pre torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/nightly/cpu",
    ...
    "preview,conda,macos,rocm4.x,python": "<b>NOTE:</b> ROCm is not available on MacOS",
    ...
    "preview,libtorch,macos,rocm4.x,cplusplus": "ROCm is not available on MacOS. Download CPU libtorch here:<br /><a href='https://download.pytorch.org/libtorch/nightly/cpu/libtorch-macos-latest.zip'>https://download.pytorch.org/libtorch/nightly/cpu/libtorch-macos-latest.zip</a>",
    ...
    "preview,pip,windows,cuda10.2,python": "CUDA-10.2 PyTorch builds are no longer available for Windows, please use CUDA-11.3",
    ...
    "preview,pip,windows,rocm4.x,python": "<b>NOTE:</b> ROCm is not available on Windows",
    "preview,conda,windows,cuda10.2,python": "CUDA-10.2 PyTorch builds are no longer available for Windows, please use CUDA-11.3",
    "preview,conda,windows,cuda11.x,python": "conda install pytorch torchvision torchaudio cudatoolkit=11.3 -c pytorch-nightly",
    "preview,conda,windows,rocm4.x,python": "<b>NOTE:</b> ROCm is not available on Windows",
    ...
    "preview,libtorch,windows,cuda10.2,cplusplus": "CUDA-10.2 PyTorch builds are no longer available for Windows, please use CUDA-11.3",
    ...
    "preview,libtorch,windows,rocm4.x,cplusplus": "<b>NOTE:</b> ROCm is not available on Windows",
    ...
    "stable,pip,linux,rocm4.x,python": "pip3 install torch torchvision --extra-index-url  https://download.pytorch.org/whl/rocm4.2",
    ...
    "stable,conda,linux,rocm4.x,python": "<b>NOTE:</b> Conda packages are not currently available for ROCm, please use pip instead<br />",
    ...
    "stable,libtorch,linux,rocm4.x,cplusplus": "LibTorch binaries are not available for ROCm, please build it from source",
    ...
    "stable,pip,macos,rocm4.x,python": "<b>NOTE:</b> ROCm is not available on MacOS",
    ...
    "stable,conda,macos,rocm4.x,python": "<b>NOTE:</b> ROCm is not available on MacOS",
    "stable,conda,macos,accnone,python": "# MacOS Conda binaries are for x86_64 only, for M1 please use wheels<br />conda install pytorch torchvision torchaudio -c pytorch",
    "stable,libtorch,macos,accnone,cplusplus": "Download here:<br /><a href='https://download.pytorch.org/libtorch/cpu/libtorch-macos-1.11.0.zip'>https://download.pytorch.org/libtorch/cpu/libtorch-macos-1.11.0.zip</a>",
    "stable,libtorch,macos,cuda10.2,cplusplus": "MacOS binaries do not support CUDA. Download CPU libtorch here:<br /><a href='https://download.pytorch.org/libtorch/cpu/libtorch-macos-1.11.0.zip'>https://download.pytorch.org/libtorch/cpu/libtorch-macos-1.11.0.zip</a>",
    "stable,libtorch,macos,cuda11.x,cplusplus": "MacOS binaries do not support CUDA. Download CPU libtorch here:<br /><a href='https://download.pytorch.org/libtorch/cpu/libtorch-macos-1.11.0.zip'>https://download.pytorch.org/libtorch/cpu/libtorch-macos-1.11.0.zip</a>",
    "stable,libtorch,macos,rocm4.x,cplusplus": "<b>NOTE:</b> ROCm is not available on MacOS",
    "stable,pip,windows,accnone,python": "pip3 install torch torchvision torchaudio",
    "stable,pip,windows,cuda10.2,python": "CUDA-10.2 PyTorch builds are no longer available for Windows, please use CUDA-11.3",
